...
#SBATCH --output=results/reg2/hw2_%j_stdout.txt
#SBATCH --error=results/reg2/hw2_%j_stderr.txt
#SBATCH --time=00:50:00
#SBATCH --job-name=hw2_regularized2
...
python hw1_base.py --hidden 400 200 100 50 25 12 --activation_out linear --epochs 1000 --results_path ./results/reg2 --exp_index $SLURM_ARRAY_TASK_ID --output_type ddtheta --predict_dim 1 --cpus_per_task $SLURM_CPUS_PER_TASK
