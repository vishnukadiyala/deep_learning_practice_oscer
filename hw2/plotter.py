...
if __name__ == "__main__":
    ...
    # move around the results to put them in form of T-test.
    
    # For 1
    base = "bmi*Ntraining_1_*results.pkl"
    no_reg = read_one_Ntrainig(args.path, base)
    #print(len(no_reg))
    
    base = "bmi*Ntraining_1_*dropout_0.25*results.pkl"
    dropout = read_one_Ntrainig(args.dropout_path, base)
    #print(len(dropout))
    
    base = "bmi*Ntraining_1_*regularization_0.0001*results.pkl"
    reg_new = read_one_Ntrainig(args.reg_path, base)
    #print(len(reg_new))
    print("#################################")
    print("T-Tests for N_training 1")
    print("T-test Between No-reg and dropout")
    res_a = scipy.stats.ttest_rel(no_reg, dropout)
    print(res_a)
    
    print("*********************************")
    print("T-test Between No-reg and L1")
    res_b = scipy.stats.ttest_rel(no_reg,reg_new)
    print(res_b)
    print("*********************************")
    print("T-test Between dropout and L1")
    res_c = scipy.stats.ttest_rel(dropout, reg_new)
    print(res_c)
    print("*********************************")
    #For 18 
    base = "bmi*Ntraining_18_*results.pkl"
    no_reg = read_one_Ntrainig(args.path, base)
    #print(len(no_reg))
    
    base = "bmi*Ntraining_18_*dropout_0.25*results.pkl"
    dropout = read_one_Ntrainig(args.dropout_path, base)
    #print(len(dropout))
    
    base = "bmi*Ntraining_18_*regularization_0.0001*results.pkl"
    reg_new = read_one_Ntrainig(args.reg_path, base)
    #print(len(reg_new))
    print("#################################")
    print("T-Tests for N_training 18")
    print("T-test Between No-reg and dropout")
    res_a = scipy.stats.ttest_rel(no_reg, dropout)
    print(res_a)
    print("*********************************")
