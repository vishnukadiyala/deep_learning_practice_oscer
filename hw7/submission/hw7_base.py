...
def create_parser():
    ...
    parser.add_argument('--model', type=str, default='autoencoder', help="What model to use")
...
def execute_exp(args=None, multi_gpus=False):
    ...
    # HW7
    ds_train, ds_valid, ds_test, num_classes = create_datasets(base_dir='/content/drive/MyDrive/PhD/AML/HW7/radiant_earth/pa',
                                                           fold= (args.exp_index + 5),
